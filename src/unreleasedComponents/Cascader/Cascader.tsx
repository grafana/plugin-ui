...
import { Icon, Input, Select } from '@grafana/ui';
...
> {
  constructor(props: CascaderProps) {
    ...
    const { rcValue, activeLabel } = this.setInitialValue(
      searchableOptions,
      props.initialValue
    );
    this.state = {
  ...
  flattenOptions = (
    ...
    for (const option of options) {
      ...
      if (!option.items) {
        ...
        selectOptions = [
          ...selectOptions,
          ...this.flattenOptions(option.items, cpy),
        ];
      }
    }
  ...
  getSearchableOptions = memoizeOne((options: CascaderOption[]) =>
