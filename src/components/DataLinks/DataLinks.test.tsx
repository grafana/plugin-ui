...
describe('DataLinks', () => {
  ...
  it('renders correctly when no fields', async () => {
    ...
    await act(
      ...
      async () => {
        wrapper = await render(<DataLinks onChange={() => {}} />);
      }
    );
  ...
  it('renders correctly when there are fields', async () => {
    ...
    await act(
      // @ts-ignore we shouldn't use Promises in act => the "void | undefined" is here to forbid any sneaky "Promise" returns.
      async () => {
        wrapper = await render(<DataLinks value={testValue} onChange={() => {}} />);
      }
    );
  ...
  it('adds new field', async () => {
    ...
    await act(
      // @ts-ignore we shouldn't use Promises in act => the "void | undefined" is here to forbid any sneaky "Promise" returns.
      async () => {
        wrapper = await render(<DataLinks onChange={onChangeMock} />);
      }
    );
  ...
  it('removes field', async () => {
    ...
    await act(
      // @ts-ignore we shouldn't use Promises in act => the "void | undefined" is here to forbid any sneaky "Promise" returns.
      async () => {
        wrapper = await render(<DataLinks value={testValue} onChange={onChangeMock} />);
      }
    );
