...
describe('DebounceSegment', () => {

  it('renders value initially', () => {
    const options = getOptions();
    const value = Chance().word();

    render(<DebounceSegment options={options} value={value} onDebounce={jest.fn()} />);
  ...
  describe('delay has not passed', () => {
    it('renders updated value', () => {
      ...
      const { container } =render(<DebounceSegment
        options={options} 
    ...
    it('does not call onDebounce with default delay', () => {
      ...
      const { container } = render(
        <DebounceSegment options={options} value={value} onDebounce={() => debounceFunction()} />
      );
  ...
  describe('delay has passed', () => {
    it('renders updated value', () => {
      ...
      const { container } = render(<DebounceSegment options={options} value={value} onDebounce={jest.fn()} />);
